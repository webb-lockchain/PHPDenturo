  ...
  <div class="flex justify-end w-full">
    ...
    if (isset($_SESSION['message'])) {
      ...
      if ($message === "Login successfully!") {
        ?>
        <script>localStorage.setItem('isLoggedIn', $_SESSION['user']);</script>
        <div id="loginButton" class="flex items-center p-8">
          <div class="termin-button-new heading-font3 highlights w-button aa"
            onclick="document.getElementById('chat-popup').style.display='block'">Make a Offer</div>
