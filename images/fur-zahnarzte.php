  ...
  <div class="flex justify-end w-full">
    <div id="logined">
      ...
      <div id="loginButton" class="flex items-center p-8">
        <div class="termin-button-new heading-font3 highlights w-button aa" onclick="document.getElementById('chat-popup').style.display='block'">Make a Quote</div>
        <div class="dropdown mr-12 ml-8">
          <img class="dropbtn w-14 h-12" src='images/icons/logedin.jpg'></img>
          <div class="dropdown-content">
            <div class="p-4 hover:bg-gray-200 hover:cursor-pointer flex flex-row" onclick="handleButtonClick('settings')">
              <img class="w-6 h-6" src="images/icons/settings.png"></img>
              <div class="ml-2">Settings</div>
            </div>
            <div class="p-4 hover:bg-gray-200 hover:cursor-pointer flex flex-row" onclick="handleButtonClick('activity')">
    ...
    <script>
      ...
      function handleButtonClick(action) {
        ...
        if (action === 'logout') {
          ...
          // Add logic to perform logout action
          // For example, redirect to logout page or make an AJAX request to log the user out
          // Once the logout action is completed, change the button text to "Login"
          // button.innerHTML = '<div class="termin-button-new heading-font3 highlights w-button aa mb-10 mt-0" onclick="document.getElementById(\'offer-popup\').style.display=\'block\'">Login</div>';
        }
      ...
      <form action="/quoteforpat.php" class="form-container" method="POST" enctype="multipart/form-data" id="quoteForm">
        ...
        <div class="w-full sm:w-2/3 mx-auto">
          <div class="flex flex-row justify-between">
            ...
            <button type="button" class="btn w-2/5 cancel" onclick="closeForm()">Close</button>
          </div>
        </div>
      </form>
