    ...
    <div class="inhalt-untereinander1">
      <div class="form-block w-form">
        <form id="Kontaktformular" name="wf-form-Kontaktformular" data-name="Kontaktformular" method="post"
          ...
          <h1 class="heading-links1 heading-1" id="contactform"></h1>
          <div class="form-text-mid flie-text" id="condtail"></div><input
...
<!-- 
          ...
          <div class="div-block-168">
            <label class="w-checkbox checkbox-field">
              <input type="checkbox" id="Datenschutz" name="Datenschutz" data-name="Datenschutz" required="" class="w-checkbox-input checkbox">
            </label>
            <p class="form-text flie-text">
              <div id="Ihd"></div> 
              <a href="datenschtuz.html" class="link-formular farbe-der-headings"  id="daten"></a> 
              <div id="conxx"></div>
            </p>
          </div> -->
          ...
          <div class="div-block-168">
            ...
            <p class="form-text flie-text">
              *Ich habe die 
              <a href="datenschtuz.html" class="link-formular farbe-der-headings">Datenschutzerklärung</a> 
              zur Kenntnis genommen.<br>Ich stimme zu, dass meine Angaben zur Kontaktaufnahme und für Rückfragen dauerhaft gespeichert werden.
            </p>
          </div>
